    ...
    <section className="mx-auto max-w-[800px] px-5 pt-[35px] pb-[30px]">
      ...
      <FadeInOnScroll variant="slide-up" delay={200}>
        <div className="font-klee text-[16px] font-normal leading-[2] text-text">
          ...
          <p className="mt-6">
            ワインソムリエとして食と酒を愛し、マンガやアニメ、カラオケに夢中になり、時には自宅で寸胴を使い出汁を取るほど料理にこだわる——そんな多彩な趣味にあふれ、自分の懐に入れた人は会っていない時間を問わず大事にする人です。
          </p>
          <p className="mt-6">
          ...
          <p className="mt-6">
            お世話になりました皆様にご足労をかける形とはなってしまいますが、多くの方が集まる場が大好きでしたので、ご都合がつきましたら、ぜひ最後に送り出していただけますと幸いです。
          </p>
          ...
          <p className="mt-6 font-semibold">
            ※出棺時間の都合上、棺に入れられるのは8日12:00までにご送信頂けたもののみになります。予めご了承ください。
          </p>
        </div>
      </FadeInOnScroll>
